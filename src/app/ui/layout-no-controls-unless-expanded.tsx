...
export class FullLayoutNoControlsUnlessExpanded extends Layout {
    override componentDidMount(): void {
        ...
        this.updateControlToggleVisibility();
        this.subscribe(this.plugin.layout.events.updated, () => this.updateControlToggleVisibility());
    }

    /** Show/hide wrench button as needed (so it never displays in non-expanded mode) */
    private updateControlToggleVisibility() {
