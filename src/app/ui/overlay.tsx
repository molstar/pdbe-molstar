...
function PDBeLoadingOverlayBox() {
    return <div className='pdbemolstar-overlay-box'>
        <svg className='pdbe-animated-logo' viewBox='0 0 300 300'>
            ...
            <path className='path-fg' fill='transparent' stroke='#72B260' strokeWidth='30' d='M 100 150 A 50 50 0 1 1 150 100 L 150 170 L 150 100 L 150 170 L 150 100 L 150 100 A 50 50 0 1 1 200 150 L 130 150 L 200 150 L 130 150 L 200 150 L 200 150 A 50 50 0 1 1 150 200 L 150 130 L 150 200 L 150 130 L 150 200 L 150 200 A 50 50 0 1 1 100 150 L 170 150 L 100 150 L 170 150 L 100 150'></path>
        </svg>;
    </div>;
}
